...
- [x]  6) BANCO DE DADOS JOBNATION - FUNCTION MÚLTIPLOS CRITÉRIOS COM CURSOR.

![06-JN-FUNCTION-PL/SQL](VÍDEO FUNÇÃO DE BUSCA POR MÚLTIPLOS CRITÉRIOS NO ORACLE:
![6.ORACLE_FUNCTION](/uploads/de7a03e4f2da61f3bce35ecabc604906/2.ORACLE_FUNCTION.mp4)
